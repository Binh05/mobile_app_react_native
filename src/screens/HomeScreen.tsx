...
const HomeScreen = () => {
  ...
  return (
    <ScrollView >
    <View style={{ flex: 1, alignItems: "center", marginTop: 30, paddingBottom: tabBarHeight }}>
      <View style={{ width: 321 }}>
        <View style={{ paddingBottom: 26 }}>
          <View style={{ marginBottom: 36 }}>
            <Text style={{ fontWeight: "bold", fontSize: 35 }}>
              Morning, Thành{user?.name}
            </Text>
          </View>
          <View
            style={{
          ...
          >
            <View style={{ alignItems: 'center'}}>
              ...
              <View style={{ position: 'absolute' }}>
                ...
                <View style={{top: 10}}>
                  <Text style={{ fontWeight: 'bold', color: '#ffffff'}}>Protein</Text>
                </View>
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              <View style={{ position: 'absolute', alignItems: 'center' }}>
                ...
                <View style={{top: 10}}>
                  <Text style={{ fontWeight: 'bold', color: '#ffffff'}}>Cab</Text>
                </View>
                <View style={{ marginTop: 90, alignItems: 'center' }}>
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              <View style={{ position: 'absolute', alignItems: 'center' }}>
                ...
                <View style={{top: 10}}>
                  <Text style={{ fontWeight: 'bold', color: '#ffffff'}}>Fat</Text>
                </View>
                <View style={{ marginTop: 90, alignItems: 'center' }}>
          ...
          <View
            style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 26 }}
          >
            <TouchableOpacity>
        ...
        <View style={{ borderRadius: 20, backgroundColor: '#232323', padding: 17, justifyContent: 'space-between', height: 191, width:  321}}>
            ...
            >
              <View style={{ flexDirection: "row", alignItems: 'flex-end' }}>
                ...
                <Text style={{ fontWeight: "bold", marginLeft: 10, color: '#85F193' }}>
                  Breakfast
                </Text>
              </View>
            ...
            <View style={{ borderRadius: 20, backgroundColor: '#343434', padding: 15}}>
